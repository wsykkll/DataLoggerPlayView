...
class TRANSFORM
{
    public:
        ...
        float      gfCameraPoseInVehicle[6];

        float      gfTransformFrontMWR2Vehicle[4][4];

        float      gfFrontMWRPoseInVehicle[6];

        float      gfTransformLeftSRR2Vehicle[4][4];

        float      gfLeftSRRPoseInVehicle[6];

        float      gfTransformRightSRR2Vehicle[4][4];

        float      gfRightSRRPoseInVehicle[6];
...
int TRANSFORM::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __int64_t_encode_array(buf, offset + pos, maxlen - pos, &this->nRTKTimeStamp, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->gfTransformCamera2Vehicle[a0][0], 4);
        if(tlen < 0) return tlen; else pos += tlen;
    }

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->gfCameraPoseInVehicle[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->gfTransformFrontMWR2Vehicle[a0][0], 4);
        if(tlen < 0) return tlen; else pos += tlen;
    }

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->gfFrontMWRPoseInVehicle[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->gfTransformLeftSRR2Vehicle[a0][0], 4);
        if(tlen < 0) return tlen; else pos += tlen;
    }

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->gfLeftSRRPoseInVehicle[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->gfTransformRightSRR2Vehicle[a0][0], 4);
        if(tlen < 0) return tlen; else pos += tlen;
    }

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->gfRightSRRPoseInVehicle[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;
...
int TRANSFORM::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __int64_t_decode_array(buf, offset + pos, maxlen - pos, &this->nRTKTimeStamp, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->gfTransformCamera2Vehicle[a0][0], 4);
        if(tlen < 0) return tlen; else pos += tlen;
    }

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->gfCameraPoseInVehicle[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->gfTransformFrontMWR2Vehicle[a0][0], 4);
        if(tlen < 0) return tlen; else pos += tlen;
    }

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->gfFrontMWRPoseInVehicle[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->gfTransformLeftSRR2Vehicle[a0][0], 4);
        if(tlen < 0) return tlen; else pos += tlen;
    }

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->gfLeftSRRPoseInVehicle[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->gfTransformRightSRR2Vehicle[a0][0], 4);
        if(tlen < 0) return tlen; else pos += tlen;
    }

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->gfRightSRRPoseInVehicle[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;
...
uint64_t TRANSFORM::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0xc422fe84ea3f804eLL +
